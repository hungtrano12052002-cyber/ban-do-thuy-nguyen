const CACHE='thuy-nguyen-v7-7-3';
const CORE=['./','./index.html','./style.css?v=7.7.3','./app.js?v=7.7.3','./data.js?v=7.7.3','./manifest.json','./config.js?v=7.7.3','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
