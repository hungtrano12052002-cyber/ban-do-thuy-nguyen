const CACHE='thuy-nguyen-v7-5-9';
const CORE=['./','./index.html','./style.css?v=7.5.9','./app.js?v=7.5.9','./data.js?v=7.5.9','./manifest.json','./config.js?v=7.5.9','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
