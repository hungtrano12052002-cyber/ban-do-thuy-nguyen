const CACHE='thuy-nguyen-v7-7-1';
const CORE=['./','./index.html','./style.css?v=7.7.2','./app.js?v=7.7.2','./data.js?v=7.7.2','./manifest.json','./config.js?v=7.7.2','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
