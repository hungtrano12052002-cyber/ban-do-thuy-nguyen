const CACHE='thuy-nguyen-v7-7-0';
const CORE=['./','./index.html','./style.css?v=7.7.0','./app.js?v=7.7.0','./data.js?v=7.7.0','./manifest.json','./config.js?v=7.7.0','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
