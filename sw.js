const CACHE='thuynguyen-v67-auto-gps';
const CORE=['./','./index.html','./style.css?v=6.7.0','./app.js?v=6.7.0','./data.js?v=6.7.0','./manifest.json','./config.js?v=6.7.0','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
