const CACHE='thuynguyen-v682-mobile';
const CORE=['./','./index.html','./style.css?v=6.8.2','./app.js?v=6.8.2','./data.js?v=6.8.2','./manifest.json','./config.js?v=6.8.2','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
