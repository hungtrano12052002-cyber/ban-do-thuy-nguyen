const CACHE='thuy-nguyen-v7-6-4';
const CORE=['./','./index.html','./style.css?v=7.6.4','./app.js?v=7.6.4','./data.js?v=7.6.4','./manifest.json','./config.js?v=7.6.4','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
