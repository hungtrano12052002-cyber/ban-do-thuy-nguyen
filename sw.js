const CACHE='thuy-nguyen-v7-5-7';
const CORE=['./','./index.html','./style.css?v=7.5.7','./app.js?v=7.5.7','./data.js?v=7.5.7','./manifest.json','./config.js?v=7.5.7','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
