const CACHE='thuy-nguyen-v6-8-4-add-fix';
const CORE=['./','./index.html','./style.css?v=6.8.4','./app.js?v=6.8.4','./data.js?v=6.8.4','./manifest.json','./config.js?v=6.8.4','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
