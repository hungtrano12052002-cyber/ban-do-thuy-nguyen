const CACHE='thuy-nguyen-v7-6-2';
const CORE=['./','./index.html','./style.css?v=7.6.2','./app.js?v=7.6.2','./data.js?v=7.6.2','./manifest.json','./config.js?v=7.6.2','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
