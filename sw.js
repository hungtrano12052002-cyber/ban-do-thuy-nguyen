const CACHE='thuy-nguyen-v6-1';
const CORE=['./','./index.html','./style.css?v=6.0.1','./app.js?v=6.0.1','./data.js?v=6.0.1','./manifest.json','./config.js?v=6.0.1','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
