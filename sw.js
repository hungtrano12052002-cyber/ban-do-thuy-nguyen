const CACHE='thuy-nguyen-v7-6-1';
const CORE=['./','./index.html','./style.css?v=7.6.1','./app.js?v=7.6.1','./data.js?v=7.6.1','./manifest.json','./config.js?v=7.6.1','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
